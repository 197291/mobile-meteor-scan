    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Scan App</Text>
        </View>
        ...
        <View style={styles.buttons}>
          <Button textStyle={{textAlign:'center'}} style={[styles.btn, {marginRight:20}]} text="Sign In" onPress={this.handleSignIn} />
          <Button textStyle={{textAlign:'center'}} style={styles.btn} text="Create Account" onPress={this.handleCreateAccount} />
        </View>
